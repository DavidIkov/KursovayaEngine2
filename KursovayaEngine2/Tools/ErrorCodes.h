...
enum class KURSAVAYAENGINE2_CORE_ERRORS : unsigned int {
	...
	*/
	TRYING_TO_CALL_IMPOSSIBLE_FUNCTION = 4,
	
	/*
	trivial, arguments are just invalid or makes not sense
	*/
	TRYING_TO_CALL_FUNCTION_WITH_INVALID_ARGUMENTS = 5,
