...
TextureClass::TextureClass(RespConstrFlag, const TextureClass& toCopy):
	Texture(RespConstrFlag(), toCopy.Texture), Size(toCopy.Size), Data(toCopy.Data), DataSizeInBits(toCopy.DataSizeInBits), StoringData(toCopy.StoringData), Settings(toCopy.Settings), DataSettings(toCopy.DataSettings), Dimensions(toCopy.Dimensions) {
	toCopy.Deleted = true;
}
...
TextureClass::TextureClass(const TextureClass&& toCopy):
	Texture(RespConstrFlag(), toCopy.Texture), Size(toCopy.Size), Data(toCopy.Data), DataSizeInBits(toCopy.DataSizeInBits), StoringData(toCopy.StoringData), 
...
void TextureClass::operator=(const TextureClass& toCopy) {
	...
	Texture = Graphics::Primitives::TextureClass(Dimensions, Size, Data, Settings, DataSettings);
}
void TextureClass::operator=(const TextureClass&& toCopy) {
	Delete();
	Deleted = false;
	...
	DataSettings = toCopy.DataSettings;
	Dimensions = toCopy.Dimensions;
	Texture = Graphics::Primitives::TextureClass(RespConstrFlag(), toCopy.Texture);
}
